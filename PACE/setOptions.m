...
param = struct('bwmu',0,'bwmu_gcv', 1, 'bwxcov',[0 0],...
  ...
  'selection_k','BIC', 'FVE_threshold',0.85,...
  'maxk',20, 'control','auto','regular',[],...
  'error',1,'ngrid',51,'method','CE', 'ls_fit', 0, ...
  ...
  'weight',0,'sigmat','constant', 'varPositive', 0);
if nargin > 0
  op_names = {'bwmu','bwmu_gcv','bwxcov', ...
    'bwxcov_gcv','ntest1','ngrid1',...
    'selection_k','FVE_threshold', 'maxk',...
    'control','regular',...
    'error','ngrid','method', 'ls_fit', ...
    'shrink','newdata','kernel', 'numBins', 'yname'...
    ,'screePlot','designPlot', 'corrPlot', 'rho','family',...
    'param','verbose','xmu','xcov','method_mu', 'out_percent', ...
    'weight', 'sigmat', 'varPositive'};
