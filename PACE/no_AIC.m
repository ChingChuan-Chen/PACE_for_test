...
function [no_opt,aic]=no_AIC(y,t,mu,bw_xcov,ngrid,regular,maxk,out1,out21,kernel,error,cut,rcov,xcov,npoly)
...
%t1 = cputime;
if error == 1
   [invalid, sigma]=pc_covE_120823(t,out1,bw_xcov,ngrid,cut,kernel, rcov, npoly);
else
   sigma = 0;
end
%t1 = cputime-t1;
