function [invalid, sigma,  xvar, yvar]=pc_covE_120823(t,out1,bw_xcov,ngrid,cut,kernel,rcov, npoly)
...
if invalid==0
  ...
  if sigma < 0
    fprintf(1, 'Warning: estimated sigma is negative, reset to 1e-4 now!\n');
    sigma = 0;
  end
else
  sigma = [];
