function [] = exampleDataGeneration(example_case)
% input: example_case:
...
switch example_case
  ...
  case {1, 2}
    ...
    if example_case == 1
      ...
      example_case_name = 'regular_with_missing';
    end
end
...
if example_case == 2
  ...
  for i = 1:ncohort
    ni_missing(i) = poissrnd(randsample(floor(mtp/4), 1), 1, 1); 
    if ni_missing(i) >= mtp
      ni_missing(i) = mtp-1;
    end
  end
...
save(['exampleCase_', example_case_name, '.mat'], 'y', 't')
end